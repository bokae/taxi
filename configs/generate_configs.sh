...
# generate different taxi to request ratios at N_taxi=2500 (corresponding to d = 200 m).

temp=`cat $base | ./add_param.sh -n num_taxis 2500`
for lambda in 9 28 47 66 94 142
do
...
for t in 100 400 1000 2500 5000 
do
	lambda=`echo "$(("$t"/53))"`
