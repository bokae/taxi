...
class City():
    ...
    def __init__(self,**config):
        if (("n" in config) and ("m" in config)):
            ...
            # array that stores plate_no of available taxis at the
...
class Request():
    ...
    def __init__(self,coordinates = None, request_id = None, timestamp = None):
        if coordinates == None:
            print("A request has to originate from somewhere.")
        elif request_id == None:
            print("A request has to appear somewhere on the map.")
        elif timestamp == None:
...
class Simulation():
    ...
    def add_request(self,request_id):
        ...
        r = Request([x,y],request_id)
        self.requests[request_id]=r # add to request storage
        self.requests_pending.append(request_id) # add to free users
    ...
    def make_request(self,user_id,user_destination):
        """
        This is a function that assigns the nearest available taxi to a user with
